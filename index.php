						...
						<div class="w3layouts-banner-top">
							<div class="container">
								<div class="agileits-banner-info">
									...
									<h3>Rahul Raj <span>Friendlife</span> ?</h3>
										<p>Life Is Masti But Masti Is NO Life </p>
									<div class="agileits_w3layouts_more menu__item">
				<a href="#" class="menu__link" data-toggle="modal" data-target="#myModal">Katap More</a>
			</div>
								</div>	
							</div>
						</div>
				...
				<div class="container">
					...
					<div class="navbar-header page-scroll">
						<button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-ex1-collapse">
							...
							<span class="sr-only">Rahul Raj Friendlife</span>
							<span class="icon-bar"></span>
							<span class="icon-bar"></span>
							<span class="icon-bar"></span>
						</button>

						<h1><a class="navbar-brand" href="index.html"><img src="images/1.jpg" width="100" height="100" style="border-radius:50%;padding-top:-1000;z-index:100; "></a></h1>
					...
					<div class="collapse navbar-collapse navbar-ex1-collapse">
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li><a class="page-scroll scroll" href="#instructors">Profile</a></li>
...
<div class="about" id="about">
      <div class="col-md-6 ab-w3-agile-info">
	   <div class="ab-w3-agile-info-text">
		 ...
		 <p>  My name is pushkar kumar my father name is upendra sharma he is  a framer my mother name is pratima devi she is house wife. i betong to ;akhibag siturted i manpur  gaya Regarding My education my 3education is B.c.a hons in Gaya colleges passing 2018Regerding my family bcakground i havbe two brothers and two sister thee are 1- member in my family included me. About my aim i want to be sucessful  person in my life. about my hobby my hld is moring wailk hvave no any hb expermece Thanks bor.</p>
		  ...
		  <div class="ab-w3-agile-inner">
	       <div class="col-md-6 ab-w3-agile-part">
				<h4>Pushkar Kumar</h4>
		     <p>I dedicate this website to <strong>Frindes</strong>  A proactie leader and Plannr With Expertise in , Market Plan Execution Account Mangemnt, Competitor and Market Analysis and Targeted Marketing.</p>
	       </div>
			<div class="col-md-6 ab-w3-agile-part two">
			<h4>Rahul kumar</h4>
		     <p>I am <strong>PushKar Kumar</strong> optimism is  the faith that leads to achievement. Nothing can be done without hope and confidence.shun raha haui to roh raha hua may tri yaad hme aane lgi hai  </p>
	       </div>
			<div class="clearfix"></div>		   
	  </div>	
   </div>	 	  
				 ...
				 <div class="col-md-3 price-grid">
					<div class="price-block agile">
						<div class="price-gd-top pric-clr1">
							<h4>	BASIC</h4>
							<h3><span>₹</span>5000.00</h3>
							<h5>Design : Fully Customized design layout</h5>
							<h1>FREE technical Support for 1 Month</h1>
						</div>
				...
				<div class="col-md-3 price-grid lost">
					<div class="price-block agile">
						<div class="price-gd-top pric-clr3">
							<h4> Fully wab design </h4>
							<h3><span>₹</span>6000</h3>
							<h5>FREE technical Support for 3 Months</h5>
						</div>
						<div class="price-gd-bottom">
	...
	<!-- instructors -->
		<div class="instructors" id="instructors">
		   <div class="container">
		     ...
		     <h3 class="title-w3">My Frined </h3>
		       <p class="sub-text">My Life </p>
		      <div class="team-grids">
					<!-- Bottom to top-->
						<div class="col-sm-4 team-grid">
							<!-- normal -->
							<div class="ih-item circle effect10 bottom_to_top">
								<div class="img"><img src="im/06.jpg" alt="img" width="210" height="220"/></div>
								<div class="info">
									<h3>Rahul Raj</h3>
									<div class="icons">
										<ul>
						...
						<div class="col-sm-4 team-grid">
							<!-- normal -->
							<div class="ih-item circle effect10 bottom_to_top">
								<div class="img"><img src="im/07.jpg" alt="img" width="210" height="220" /></div>
								<div class="info">
									<h3>Rahul kumar</h3>
									<div class="icons">
										<ul>
						...
						<div class="col-sm-4 team-grid">
							<!-- normal -->
							<div class="ih-item circle effect10 bottom_to_top">
								<div class="img"><img src="im/111.jpg" alt="img" width="210" height="220" /></div>
								<div class="info">
									<h3>Kantap </h3>
									<div class="icons">
										<ul>
						...
						<div class="col-sm-4 team-grid">
							<!-- normal -->
							<div class="ih-item circle effect10 bottom_to_top">
								<div class="img"><img src="im/112.jpg" alt="img" width="210" height="220"/></div>
								<div class="info">
									<h3>kantap</h3>
									<div class="icons">
										<ul>
						...
						<div class="col-sm-4 team-grid">
							<!-- normal -->
							<div class="ih-item circle effect10 bottom_to_top">
								<div class="img"><img src="im/113.jpg" alt="img" width="210" height="220"/></div>
								<div class="info">
									<h3>katap</h3>
									<div class="icons">
										<ul>
						...
						<div class="col-sm-4 team-grid">
							<!-- normal -->
							<div class="ih-item circle effect10 bottom_to_top">
								<div class="img"><img src="im/120.jpg" alt="img" width="210" height="220"/></div>
								<div class="info">
									<h3>kantap</h3>
									<div class="icons">
										<ul>
			...
			<div class="gallery-grids carouselGallery-grid hidden-xs">
				<div class="col-md-4 gallery-grid">
					<div class="carouselGallery-col-1 carouselGallery-carousel" data-likes="3144" data-index="0" data-username=" " data-imagetext="At vero eos et accusamus et iusto odio 
						...
						style="background-image:url(im/112.jpg);">
				...
				<div class="col-md-4 gallery-grid">
					<div class="carouselGallery-col-1 carouselGallery-carousel" data-likes="3144" data-index="1" data-username=" " data-imagetext="Occaecati at vero eos et accusamus et iusto odio 
						...
						style="background-image:url(im/113.jpg);">
						<div class="carouselGallery-item">
							<div class="carouselGallery-item-meta">
								<span class="carouselGallery-item-meta-user">
								Photo Gallery
				...
				<div class="col-md-4 gallery-grid">
					<div class="carouselGallery-col-1 carouselGallery-carousel" data-likes="3144" data-index="2" data-username=" " data-imagetext="similique sunt in culpa qui
						...
						style="background-image:url(im/08.jpg);">
						<div class="carouselGallery-item">
							<div class="carouselGallery-item-meta">
								<span class="carouselGallery-item-meta-user">
								Photo Gallery
				...
				<div class="col-md-4 gallery-grid">
					<div class="carouselGallery-col-1 carouselGallery-carousel" data-likes="3144" data-index="3" data-username=" " data-imagetext="At vero eos et accusamus et iusto odio 
						...
						style="background-image:url(im/117.jpg);">
						<div class="carouselGallery-item">
							<div class="carouselGallery-item-meta">
								<span class="carouselGallery-item-meta-user">
								Photo Gallery
				...
				<div class="col-md-4 gallery-grid">
					<div class="carouselGallery-col-1 carouselGallery-carousel" data-likes="3144" data-index="4" data-username=" " data-imagetext="Similique sunt in culpa qui at vero eos et accusamus et iusto odio 
						...
						style="background-image:url(im/118.jpg);">
						<div class="carouselGallery-item">
							<div class="carouselGallery-item-meta">
								<span class="carouselGallery-item-meta-user">
								Photo Gallery
				...
				<div class="col-md-4 gallery-grid">
					<div class="carouselGallery-col-1 carouselGallery-carousel" data-likes="3144" data-index="5" data-username=" " data-imagetext="At vero eos et accusamus et iusto odio 
						...
						style="background-image:url(im/09.jpg);">
						<div class="carouselGallery-item">
							<div class="carouselGallery-item-meta">
								<span class="carouselGallery-item-meta-user">
								Photo Gallery
...
Happy Students </h3>
						...
						<ul class="rslides" id="slider3">
							<li>
								 <div class="agileits-clients">
									...
									<div class=" client_agile_info">
											...
											<p>Sun raha hai na kyu  ro rhi hu mai</p>
											<h4><img src="im/123.jpg" alt="">Rahul Raj</h4>
							...
							<div class="agileits-clients">
								...
								<div class="client_agile_info">
                                        ...
                                        <div class="c-img"><i class="fa fa-quote-right"></i> </div>
										<p>Sun raha hai na kyu  ro rhi hu mai</p>
										<h4><img src="im/124.jpg" alt="">Rausan kumar</h4>
							...
							<div class="agileits-clients">
							     <div class=" client_agile_info">
                                        ...
                                        <div class="c-img"><i class="fa fa-quote-right"></i> </div>
										<p>Sun raha Hai no kyo ro hri mau</p>
										<h4><img src="im/125.jpg" alt="">Pushkar</h4>
	...
	<div class="agile-contact">
		...
		<div class="cont-top">
			...
			<a href="mailto:info@example.com">krpushkar1997@gmail.comm</a>
		</div>
		<div class="con-bot">
			<div class="left-bw3">
				<h5><i class="fa fa-map-marker" aria-hidden="true"></i>Address</h5>
				<p>Gaya Manpur Gaya</p>
				<p>pin 823003</p>
				<p>j.j.collges</p>
			</div>
			<div class="right-bw3">
				<h5><i class="fa fa-phone" aria-hidden="true"></i>Phone</h5>
				<p>Telephone : +91 7260839439</p>
				<p>Telephone : +91 8809251649</p>
				<p>Telephone : +91 7260834939</p>
			</div>
		</div>
	</div>
	<div class="clearfix"></div>
		...
		<div class="contact-top">
			...
			<form action="#" method="post" class="contact_form slideanim">
				...
				<div class="message">
					...
					Name	<input type="text" class="margin-right" Name="N" placeholder="Name" required="">
					Email	<input type="email" Name="Email" placeholder="E" required="">
					Phone  number	<input type="text" class="margin-right" Name="P" placeholder="Phone Number" required="">
					</div>

					<div class="col-md-6 col-sm-6 grid_6 c1">
						<textarea name="M" placeholder="Message" required=""></textarea>
					</div>
					<div class="clearfix"></div>
				</div>

				<input type="submit" value="SEND MESSAGE" name="S">
			</form>
...
<!-- footer -->
			<div class="copy-right">
				<p>&copy; 2018 Gaya collages gaya Student  <a href="http://Hermit Design & Development.com/">Pushkar kumar Design & Development</a></p>
			</div>
...
<?php
       if(isset($_POST['S']))
       {
         ...
         echo $N;
          ...
          $q="insert into project values('$N','$E','$P','$M')";
          mysql_query($q);
        }
        ?>
</body>
